{{-- <meta charset="utf-8" /> --}}
    ...
    <link
        ...
        rel="stylesheet" />
    <link rel="icon" href="{{ asset('image/logo_imam-removebg-preview.png') }}" class="spinner-border">
    <link rel="stylesheet" href="{{ asset('css/dashboard.css') }}">
    <link rel="icon" href="{{ asset('image/logo_imam-removebg-preview.png') }}" class="spinner-border" style="width: 80px; height: 50px;">
